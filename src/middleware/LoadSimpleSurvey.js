...
export default function(context) {
    ...
    context.survey = _.each(getTestSurvey().fields, function(item) {
        ...
        if (item.hasOwnProperty('properties')) {
            tmpItem.properties.choices = _.each(
        ...
        thankyou_screens: [
            {
                ...
                properties: {
                    ...
                    redirect_url:
                        'https://admin.typeform.com/powered-by?utm_campaign=nYkngh&utm_source=typeform.com-14118484-Basic&utm_medium=typeform&utm_content=typeform-thankyoubutton&utm_term=EN'
                },
                attachment: {
                    type: 'image',
