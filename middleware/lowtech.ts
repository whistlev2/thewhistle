...
class Lowtech {
    ...
    static getFormLogic() {
        let form = Lowtech.getForm();
        return form.logic;
    }

    static getQuestionLogic(questionRef) {
        let formLogic = Lowtech.getFormLogic();
    ...
    static getBranches(req, res) {
        res.send(Lowtech.getPage('d6d24d19-dd8b-4a99-b7e7-74be45eb77bc'));
    }
    ...
    static getPage(questionRef) {
        ...
        let ret = [ questionRef ];
        let currentQuestion = Lowtech.getNextQuestion(questionRef);
        while (currentQuestion) {
            ret.push(currentQuestion);
            currentQuestion = Lowtech.getNextQuestion(currentQuestion);
        }
        return ret;
    }
    ...
    static getNextQuestion(questionRef) {
        ...
        return Lowtech.hasLogic(questionRef) ?
            Lowtech.getConstantJump(questionRef) : Lowtech.getQuestionAfter(questionRef);
    }
    ...
    static getConstantJump(questionRef) {
        ...
        let questionLogic = Lowtech.getQuestionLogic(questionRef);
    ...
    static getQuestionAfter(questionRef) {
        ...
        let fields = Lowtech.getFormFields();
    ...
    static getNextQuestions(questionId) {
        if (!questionId) {
            const firstQuestion = Lowtech.getFirstQuestion();
            return Lowtech.getNextQuestions(firstQuestion);
        } else {
            return Lowtech.getPage(questionId);
        }
    }

    static getFirstQuestion() {
        const fields = Lowtech.getFormFields();
        return fields[0].ref;
    }
}
